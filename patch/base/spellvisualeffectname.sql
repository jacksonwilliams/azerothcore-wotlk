...
-- Dumping structure for table dbc.spellvisualeffectname
CREATE TABLE IF NOT EXISTS `spellvisualeffectname` (
  `ID` int unsigned NOT NULL DEFAULT '0',
  `Name` text CHARACTER SET utf8mb3 COLLATE utf8_general_ci,
  `FilePath` text CHARACTER SET utf8mb3 COLLATE utf8_general_ci,
...
-- Dumping data for table dbc.spellvisualeffectname: ~3,943 rows (approximately)
INSERT INTO `spellvisualeffectname` (`ID`, `Name`, `FilePath`, `AreaEffectSize`, `Scale`, `MinAllowedScale`, `MaxAllowedScale`) VALUES
	(1, 'SeedOfCorruption_State', 'Spells\\SeedOfCorruption_State.mdx', 1, 1, 0.01, 100),
